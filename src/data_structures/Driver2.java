/*  Driver.java
    This is a more advanced test program for Project #1
    Please note that this driver does not test all functionality
    of your implementations.  You may still have bugs even if no 
    errors are reported by this driver.
...
public class Driver2 {
    ...
    public Driver2() {
        array = new int[SIZE];
        /* Uncomment the implementation you want to test. */
...
/*  Comment out this block for linked list based implementations  */  
/******************************************************************/     
//       if(!pq.isFull())
