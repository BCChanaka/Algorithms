...
public class BinarySearchTreeTest {
    BinarySearchTree<String,String> ht;

    @Before
    public void setUp() throws Exception {
        ht = new BinarySearchTree<String, String>();
    }
    ...
    public void testAdd() {
        ...
        BinarySearchTree<String, String> _ht = new BinarySearchTree<String, String>();
    ...
    {
        BinarySearchTree<String, Integer> _ht = new BinarySearchTree<String, Integer>();
        _ht.add("nicknames", 1);
        _ht.add("nicknames", 2);
        _ht.add("nicknames", 3);
    ...
    public void testGetKey() {
     ...
     // first one found. 
        ...
        DictionaryADT<String,Integer> dictionary = new BinarySearchTree<String, Integer>();
